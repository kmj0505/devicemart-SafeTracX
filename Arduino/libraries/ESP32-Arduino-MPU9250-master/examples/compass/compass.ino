...
void loop()
{
  ...
  Serial.printf("\r\n Accel(%.6f, %.6f, %.6f)",IMU.getAccelX_mss(), IMU.getAccelY_mss(), IMU.getAccelZ_mss());
  Serial.printf("\r\n Gyro(%.6f, %.6f, %.6f)",IMU.getGyroX_rads(), IMU.getGyroY_rads(), IMU.getGyroZ_rads());
  Serial.printf("\r\n Mag(%.6f, %.6f, %.6f)",IMU.getMagX_uT(), IMU.getMagY_uT(), IMU.getMagZ_uT());
  Serial.printf("\r\n Yaw %.6f ", 
